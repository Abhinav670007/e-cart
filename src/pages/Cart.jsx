...
function Cart() {
  ...
  const handleCart=()=>{
    alert('thanktou....your Order placed successfull')
      dispatch(emptyCart())
      navigate('/')
  }
        ...
        <div className='col-lg-6 m-5'>
          <table className='table border shadow'>
            ...
            <tbody>
              {cartArray?.map((item,index)=>(<tr>
                ...
                <td>{item.price}</td>
                <td><Button onClick={()=>dispatch(removeFromCart(item.id))} varient="outline-danger rounded"><i class="fa-solid fa-trash text-danger"></i></Button></td>
              </tr>))
                }
            </tbody>
          </table>
          ...
          <div className='col-lg-4 d-flex justify-center align-items-center flex-column'>
            <div className='border shadow p-5'>
              <h2 style={{overflowY:'hidden'}}>cart summary</h2>
